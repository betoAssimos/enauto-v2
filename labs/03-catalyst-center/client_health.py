...
client_health_url = base_url + "/dna/intent/api/v1/client-health"
...
health_request = requests.get(url=client_health_url, headers=headers, verify=False).json()
print(health_request["response"])